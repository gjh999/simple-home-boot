	...
	*/
    ...
    public ResultVO EgovIndvdlSchdulManageDelete(
		...
		if (!isOwnerOrAdmin(schdulId, user)) {
			return resultVoHelper.buildFromMap(new HashMap<String, Object>(), ResponseCode.AUTH_ERROR);
		}
	 ...
	 */
	private boolean isOwnerOrAdmin(String schdulId, LoginVO user) throws Exception {
		...
		IndvdlSchdulManageVO detail = egovIndvdlSchdulManageService.selectIndvdlSchdulManageDetail(probe);
