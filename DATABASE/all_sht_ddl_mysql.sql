...
CREATE TABLE TB_CMMNTY (
  ...
  CMMNTY_NM varchar(60) DEFAULT NULL,
  USE_AT char(1) DEFAULT NULL,
  FRST_REGIST_PNTTM datetime DEFAULT NULL, FRST_REGISTER_ID varchar(20) DEFAULT NULL, LAST_UPDT_PNTTM datetime DEFAULT NULL, LAST_UPDUSR_ID varchar(20) DEFAULT NULL,
  PRIMARY KEY (CMMNTY_ID)
) ;
CREATE TABLE TB_CMMNTY_USER (
  ESNTL_ID varchar(20) NOT NULL,
  CMMNTY_ID varchar(20) DEFAULT NULL,
  EMPLYR_ID varchar(20) DEFAULT NULL,
  MNGR_AT char(1) DEFAULT NULL,
  USE_AT char(1) DEFAULT NULL,
  REGIST_SE_CODE varchar(6) DEFAULT NULL,
  FRST_REGIST_PNTTM datetime DEFAULT NULL, FRST_REGISTER_ID varchar(20) DEFAULT NULL, LAST_UPDT_PNTTM datetime DEFAULT NULL, LAST_UPDUSR_ID varchar(20) DEFAULT NULL,
  PRIMARY KEY (ESNTL_ID)
) ;
CREATE TABLE TB_CLUB (
  CLB_ID varchar(20) NOT NULL,
  CLB_NM varchar(60) DEFAULT NULL,
  USE_AT char(1) DEFAULT NULL,
  FRST_REGIST_PNTTM datetime DEFAULT NULL, FRST_REGISTER_ID varchar(20) DEFAULT NULL, LAST_UPDT_PNTTM datetime DEFAULT NULL, LAST_UPDUSR_ID varchar(20) DEFAULT NULL,
  PRIMARY KEY (CLB_ID)
) ;
CREATE TABLE TB_CLUB_USER (
  ESNTL_ID varchar(20) NOT NULL,
  CLB_ID varchar(20) DEFAULT NULL,
  EMPLYR_ID varchar(20) DEFAULT NULL,
  OPRTR_AT char(1) DEFAULT NULL,
  USE_AT char(1) DEFAULT NULL,
  REGIST_SE_CODE varchar(6) DEFAULT NULL,
  FRST_REGIST_PNTTM datetime DEFAULT NULL, FRST_REGISTER_ID varchar(20) DEFAULT NULL, LAST_UPDT_PNTTM datetime DEFAULT NULL, LAST_UPDUSR_ID varchar(20) DEFAULT NULL,
  PRIMARY KEY (ESNTL_ID)
...
CREATE TABLE TB_DIARY_INFO (
  ...
  SCHDUL_ID varchar(20) DEFAULT NULL,
  DIARY_CN varchar(2500) DEFAULT NULL,
  FRST_REGIST_PNTTM datetime DEFAULT NULL, FRST_REGISTER_ID varchar(20) DEFAULT NULL, LAST_UPDT_PNTTM datetime DEFAULT NULL, LAST_UPDUSR_ID varchar(20) DEFAULT NULL,
